                  ...
                  <tr>
                    <td class="content-padding">
                      ...
                      <div style="margin-top: 14px;">
                        <p class="text-body">
                          Thank you for registering with us! We're thrilled to have you as part of our community. Your account has been successfully created.
                        </p>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td class="footer">
                      ...
                      <div style="margin-top: 16px;">
                        <p class="text-body">
                          Your journey to homeownership starts now. To begin your application process, please log in to your account using the button below.
                        </p>
                      </div>
                      <table role="presentation" class="button-container" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                          <td align="center">
                            <table class="button" role="presentation" cellspacing="0" cellpadding="0" border="0">
                              <tr>
                                <td>
                                  <a href="https://profiling.ibommortgagebank.com/login" target="_blank">
